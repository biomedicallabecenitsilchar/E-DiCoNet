...
function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = ELM_Test(train_data, test_data, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
[x,PredictedLabels] = max(TY);
[x, ExpectedLabel] = max(TV.T);
save TY TY
save PredictedLabels PredictedLabels
save ExpectedLabel ExpectedLabel